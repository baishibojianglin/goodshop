...
class CompanyUser extends Validate
{
    protected $rule = [
        ...
        'phone|供应商用户电话号码' => 'require|unique:company_user|max:20'
    ];

    protected $message = [
        'user_name.require' => '供应商用户名称不能为空',
        'user_name.unique' => '供应商用户名称已存在', // 唯一性
        'user_name.max' => '供应商用户名称长度为2~20',
        'account.require' => '供应商用户账号不能为空',
        'account.unique' => '供应商用户账号已存在', // 唯一性
        'account.max' => '供应商用户账号长度为2~20'
    ];
